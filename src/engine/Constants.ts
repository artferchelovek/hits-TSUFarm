...
export const initialGameState: GameState = {
  ...
  buildings: {
    ...
    "garden-1": {
      id: "garden-1",
      harvestType: ResourceType.Wheat,
      type: BuildingType.Garden,
      position: { x: 116, y: 107 },
      width: 4,
      length: 6,
      harvest: {
        type: ResourceType.Wheat,
      ...
      isWatered: false,
      health: 100,
      assignedWorkerId: "res-1",
    },
    // "garden-2": {
    //   id: "garden-2",
    //   harvestType: ResourceType.Tomato,
    //   type: BuildingType.Garden,
    ...
    // "garden-3": {
    //   id: "garden-3",
    //   harvestType: ResourceType.Potato,
    //   type: BuildingType.Garden,
    //   position: { x: 121, y: 106 },
    //   width: 3,
    //   length: 1,
    //   harvest: {
    //     type: ResourceType.Potato,
